...
public class SpotFinderJava extends AbstractAIProcessor {
	...
	final static Logger logger = LoggerFactory.getLogger(SpotFinderJava.class);
	
	public SpotFinderJava() {
		super();
		config = new FindConfig();
	}
	
	public SpotFinderJava(SpotFinderCL finder) {
...
//		ByteBuffer maskBuffer = Buffers.newDirectByteBuffer(frameBuffer.capacity());
		...
		info.threshold = getConfig().getInt("threshold");
